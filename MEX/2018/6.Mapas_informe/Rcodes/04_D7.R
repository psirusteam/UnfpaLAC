...
# Loading data ------------------------------------------------------------
poststrat_df <- readRDS("MEX/2018/4.D7/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99") %>% 
  rename(pobreza2 = pobreza)
...
bynames <- mutate(
  bynames,
  outPaht = paste0("MEX/2018/6.Mapas_informe/Output/D7_", paste0(V1, "_", V2),
                   ".pdf")
)
...
brks_lp <- c(0.80, 0.85,0.9,0.95,1)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados.pdf",
  width = 2000,
  height = 1500,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados.png",
  width = 2000,
  height = 1500,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados.jpeg",
  width = 2000,
  height = 1500,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados_unida.pdf",
  width = 2000,
  height = 1500,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados_unida.png",
  width = 2000,
  height = 1500,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados_unida.jpeg",
  width = 2000,
  height = 1500,
  asp = 0
)
...
tmap_save(
  Mapa1,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados_unida_etnia1.pdf",
  width = 2000,
  height = 1500,
  asp = 0
)
...
tmap_save(
  mosaico,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados_unida_etnia.pdf",
  width = 8920,
  height = 4080,
  asp = 0
)
tmap_save(
  mosaico,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados_unida_etnia.png",
  width = 8920,
  height = 4080,
  asp = 0
)
tmap_save(
  mosaico,
  "MEX/2018/6.Mapas_informe/Output/D7_Estados_unida_etnia.jpeg",
  width = 8920,
  height = 4080,
  asp = 0
)
...
## Exportando tablas 
poststrat_df <- readRDS("MEX/2018/4.D7/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99") %>% rename(pobreza2 = pobreza )
...
bynames <- mutate(
  bynames,
  outPaht = paste0("MEX/2018/6.Mapas_informe/Output/D7_unida_", paste0(V1, "_", V2),
                   ".png")
)
...
brks_lp <- as.numeric(round(c(0.80,quantile(temp_brks, c(.1,0.2,0.4, 0.60,0.80)),1),3))
