...
bynames <- mutate(
  bynames,
  outPaht = paste0("MEX/2018/6.Mapas_informe/Output/D6_", paste0(V1, "_", V2),
                   ".pdf")
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados.pdf",
  width = 4920,
  height = 3080,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados.png",
  width = 4920,
  height = 3080,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados.jpeg",
  width = 4920,
  height = 3080,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados_unida.pdf",
  width = 4920,
  height = 3080,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados_unida.png",
  width = 4920,
  height = 3080,
  asp = 0
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados_unida.jpeg",
  width = 4920,
  height = 3080,
  asp = 0
)
...
tmap_save(
  Mapa1,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados_unida_etnia1.pdf",
  width = 2000,
  height = 1500,
  asp = 0
)
...
tmap_save(
  mosaico,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados_unida_etnia.pdf",
  width = 8920,
  height = 4080,
  asp = 0
)
tmap_save(
  mosaico,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados_unida_etnia.png",
  width = 8920,
  height = 4080,
  asp = 0
)
tmap_save(
  mosaico,
  "MEX/2018/6.Mapas_informe/Output/D6_Estados_unida_etnia.jpeg",
  width = 8920,
  height = 4080,
  asp = 0
)
...
bynames <- mutate(
  bynames,
  outPaht = paste0("MEX/2018/6.Mapas_informe/Output/D6_unida_", paste0(V1, "_", V2),
                   ".png")
)
...
brks_lp <- c(0,0.30,0.4, 0.50, 0.60, 0.70,0.80,1)
bynames$dat_df  <- bynames$dat_df %>% map(~.x %>% rename(depto = "dam"))
bynames$Maps = pmap(bynames , function(...) {
  Aux_Maps(Shape = ShapeSAE%>% rename(depto = "dam"),  color_p = "RdYlGn" , 
           brks = brks_lp,...)
})


paso <- cod_shape %>% inner_join(
dat_df[[2]] %>% filter(edad == "2") %>% data.frame()
  )
paso %>% mutate(area = ifelse(area == "1", "Urbana","Rural"),
                edad = "15 - 29")
