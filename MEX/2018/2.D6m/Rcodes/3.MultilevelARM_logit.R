...
encuesta_mrp <- readRDS("MEX/2018/2.D6m/Data/encuesta_mrp.rds") %>% select(-dam2)
...
saveRDS(fit, file = "MEX/2018/2.D6m/Data/fit_mrp_logit.rds")
fit <- readRDS(file = "MEX/2018/2.D6m/Data/fit_mrp_logit.rds")
