...
encuesta_mrp <- readRDS("MEX/2018/2.D6m/Data/encuesta_mrp.rds")
statelevel_predictors_df <- readRDS("MEX/2018/2.D6m/Data/statelevel_predictors_df.rds")
fit <- readRDS("MEX/2018/2.D6m/Data/fit_mrp_logit.rds")
...
#fit<-readRDS("MEX/2018/2.D6m/Data/fit_bayes.rds")

print(fit)
resume_fit <- summary(fit) %>% data.frame()
bayesplot::mcmc_rhat(resume_fit$Rhat)
saveRDS(fit, file = "MEX/2018/2.D6m/Data/fit_bayes.rds")
...
ggsave(filename = "MEX/2018/2.D6m/Output/Compara_modelos.jpeg", plot1, scale = 3)
