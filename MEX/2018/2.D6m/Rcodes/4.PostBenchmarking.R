...
encuesta_mrp <-
  readRDS("MEX/2018/2.D6m/Data/encuesta_mrp.rds") %>%
  select(-dam2)
censo_mrp <-
  readRDS("MEX/2018/2.D6m/Data/censo_mrp.rds") 
statelevel_predictors_df <-
  readRDS("MEX/2018/2.D6m/Data/statelevel_predictors_df.rds") %>% 
...
jpeg(file = "MEX/2018/2.D6m/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>% select(byAgrega,pobreza,pobreza2, n,gk,epred_mat),
        "MEX/2018/2.D6m/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "MEX/2018/2.D6m/Data/encuesta_mrp.RDS")
