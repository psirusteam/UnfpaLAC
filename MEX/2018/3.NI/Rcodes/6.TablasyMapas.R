...
bynames <- mutate(
  bynames,
  outPaht = paste0("MEX/2018/3.NI/Output/pobreza_", paste0(V1, "_", V2),
                   ".pdf")
)
...
tmap_save(
  Mapa_lp,
  "MEX/2018/3.NI/Output/Estados.pdf",
  width = 6920,
  height = 4080,
  asp = 0
)
...
openxlsx::write.xlsx(dat_df, file = "MEX/2018/3.NI/Output/tablas.xlsx", 
                     overwrite = TRUE, )
