...
saveRDS(fit, file = "MEX/2018/3.NI/Data/fit_bayes.rds")
...
############################################################
 fit_freq <- readRDS("MEX/2018/3.NI/Data/fit_mrp_logit.rds")
 fit_Bayes <- readRDS("MEX/2018/3.NI/Data/fit_bayes.rds")

# # Graphical posterior predictive checks -----------------------------------
 new_encuesta <- encuesta_mrp %>% inner_join(statelevel_predictors_df, by = "dam")
 y_sam<- as.numeric(new_encuesta$NI)
...
ggsave(filename = "MEX/2018/3.NI/Output/Compara_modelos.jpeg", plot1, scale = 3)
