...
Mujer_NI <- read_sav("MEX/2018/5.NI_Razon/Data/Mujer_2018.sav") %>%
...
c(estimacion_dir,estimacion_dir2) %>% 
  openxlsx::write.xlsx(file = "MEX/2018/5.NI_Razon/Output/Tablas/Estimacion_dir.xlsx")

ENADID2 %>% 
  saveRDS("MEX/2018/5.NI_Razon/Data/encuesta_NI.rds")
