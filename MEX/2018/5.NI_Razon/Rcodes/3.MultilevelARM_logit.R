...
encuesta_mrp <- readRDS("MEX/2018/5.NI_Razon/Data/encuesta_mrp.rds") %>% select(-dam2)
...
byAgrega <-
  grep(
    pattern =  "^(n|usametodo|usamoderno|NI|pobreza|
              |upm|estrato|fexp)",
...
saveRDS(fit, file = "MEX/2018/5.NI_Razon/Data/fit_mrp_logit.rds")
fit <- readRDS(file = "MEX/2018/5.NI_Razon/Data/fit_mrp_logit.rds")
