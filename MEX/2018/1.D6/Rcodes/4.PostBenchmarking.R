...
encuesta_mrp <-
  readRDS("MEX/2018/1.D6/Data/encuesta_mrp.rds") %>%
  select(-dam2)
censo_mrp <-
  readRDS("MEX/2018/1.D6/Data/censo_mrp.rds") 
...
jpeg(file = "MEX/2018/1.D6/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>% select(byAgrega,pobreza,pobreza2, n,gk,epred_mat),
        "MEX/2018/1.D6/Data/poststrat_df.RDS")
