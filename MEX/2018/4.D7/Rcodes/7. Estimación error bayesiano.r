...
Estima_D7    <- readRDS("MEX/2018/4.D7/Data/poststrat_df.RDS")
##### Cargando los fit de los tres indicadores D6/D6m y NI
fit_mrp_stan_D6  <- readRDS("MEX/2018/1.D6/Data/fit_bayes.rds")
fit_mrp_stan_D6m <- readRDS("MEX/2018/2.D6m/Data/fit_bayes.rds")
fit_mrp_stan_NI  <- readRDS("MEX/2018/3.NI/Data/fit_bayes.rds")
