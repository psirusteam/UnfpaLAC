...
ENDS<-readRDS("COL/2015/3.NI/Data/base_estimaciones.rds")
...
####### Edad Cuadro 10.5.1.1 Pag.145)
#######    Necesidad de métodos anticonceptivos para mujeres en unión
...
####### Por Departamento  ####### Edad Cuadro 10.5.1.2 Pag.146)
#######    Necesidad de métodos anticonceptivos para mujeres en unión
...
openxlsx::write.xlsx(NI_Depto, file = "COL/2015/3.NI/Output/Tablas/NI_Depto.xlsx")


####### Area Cuadro 10.5.1.1 Pag.145)
#######    Necesidad de métodos anticonceptivos para mujeres en unión
...
openxlsx::write.xlsx(NI_area, file = "COL/2015/3.NI/Output/Tablas/NI_area.xlsx")
...
openxlsx::write.xlsx(NI_edad, file = "COL/2015/3.NI/Output/Tablas/NI_edad.xlsx")

####### Años estudio ####### Edad Cuadro 10.5.1.1 Pag.145)
#######    Necesidad de métodos anticonceptivos para mujeres en unión
...
openxlsx::write.xlsx(NI_anoest, file = "COL/2015/3.NI/Output/Tablas/NI_anoest.xlsx")
...
NI_etnia = design.base.total %>% group_by(etnia) %>%
  summarise(n = unweighted(n()),
            NI = survey_mean(nec_insat,
                              vartype = c("cv")))
...
openxlsx::write.xlsx(NI_etnia, file = "COL/2015/3.NI/Output/Tablas/NI_etnia.xlsx")
...
openxlsx::write.xlsx(NI_discap, file = "COL/2015/3.NI/Output/Tablas/NI_Discp.xlsx")
...
openxlsx::write.xlsx(NI_area_anoest, file = "COL/2015/3.NI/Output/Tablas/NI_area_escolaridad.xlsx")
...
openxlsx::write.xlsx(NI_depto_edad, file = "COL/2015/3.NI/Output/Tablas/NI_Depto_edad.xlsx")
...
openxlsx::write.xlsx(NI_mpio, file = "COL/2015/3.NI/Output/Tablas/NI_mpio.xlsx")
