...
tasa_desocupados <- readRDS("COL/2015/3.NI/Data/tasa_desocupacion.rds")
...
#fit<-readRDS("COL/2015/3.NI/Data/fit_bayes.rds")

print(fit)

saveRDS(fit, file = "COL/2015/3.NI/Data/fit_bayes.rds")
...
############################################################
# fit_freq <- readRDS("COL/2015/3.NI/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("COL/2015/3.NI/Data/fit_bayes.rds")
...
# ggsave(filename = "COL/2015/3.NI/Output/Compara_modelos.jpeg", plot1, scale = 3)
