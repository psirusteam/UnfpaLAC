...
encuesta_mrp <- readRDS("COL/2015/2.D6m/Data/encuesta_mrp.rds")
tasa_desocupados <- readRDS("COL/2015/2.D6m/Data/tasa_desocupacion.rds")
...
#fit<-readRDS("COL/2015/2.D6m/Data/fit_bayes.rds")

print(fit)

saveRDS(fit, file = "COL/2015/2.D6m/Data/fit_bayes.rds")
...
############################################################
# fit_freq <- readRDS("COL/2015/2.D6m/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("COL/2015/2.D6m/Data/fit_bayes.rds")
...
# ggsave(filename = "COL/2015/2.D6m/Output/Compara_modelos.jpeg", plot1, scale = 3)
