...
# Loading data ------------------------------------------------------------
poststrat_df <- readRDS("COL/2015/4.D7/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
...
bynames <- mutate(
  bynames,
  outPaht = paste0("COL/2015/4.D7/Output/pobreza_", paste0(V1, "_", V2),
                   ".pdf")
)
...
tmap_save(
  Mapa_lp,
  "COL/2015/4.D7/Output/Estados.pdf",
  width = 6920,
  height = 4080,
  asp = 0
)
...
openxlsx::write.xlsx(dat_df, file = "COL/2015/4.D7/Output/tablas.xlsx", 
                     overwrite = TRUE, )
