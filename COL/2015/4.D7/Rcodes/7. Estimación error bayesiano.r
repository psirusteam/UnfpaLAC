...
Estima_D7    <- readRDS("COL/2015/4.D7/Data/poststrat_df.RDS")
##### Cargando los fit de los tres indicadores D6/D6m y NI
fit_mrp_stan_D6  <- readRDS("COL/2015/1.D6/Data/fit_bayes.rds")
fit_mrp_stan_D6m <- readRDS("COL/2015/2.D6m/Data/fit_bayes.rds")
fit_mrp_stan_NI  <- readRDS("COL/2015/3.NI/Data/fit_bayes.rds")
...
openxlsx::write.xlsx(tabla_est, file = "COL/2015/4.D7/Output/tablas_ECM.xlsx",
                     overwrite = TRUE)
