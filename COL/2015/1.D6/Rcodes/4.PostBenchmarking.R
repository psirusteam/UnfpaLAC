...
fit <- readRDS("COL/2015/1.D6/Data/fit_mrp_logit.rds")
...
jpeg(file = "COL/2015/1.D6/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>%
        select(!matches("_\\d{,2}$")), 
        "COL/2015/1.D6/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "COL/2015/1.D6/Data/encuesta_mrp.RDS")
