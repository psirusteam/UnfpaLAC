...
encuesta_mrp <- readRDS("COL/2015/1.D6/Data/encuesta_mrp.rds")
...
#fit<-readRDS("COL/2015/1.D6/Data/fit_bayes.rds")

print(fit)

saveRDS(fit, file = "COL/2015/1.D6/Data/fit_bayes.rds")
...
############################################################
# fit_freq <- readRDS("COL/2015/1.D6/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("COL/2015/1.D6/Data/fit_bayes.rds")
...
# ggsave(filename = "COL/2015/1.D6/Output/Compara_modelos.jpeg", plot1, scale = 3)
