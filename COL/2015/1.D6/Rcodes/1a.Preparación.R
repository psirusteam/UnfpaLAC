...
####################################################
encuesta <- readRDS("COL/2015/1.D6/Data/ENDS.rds")
censo_mrp <- readRDS("COL/2015/1.D6/Data/censo_mrp.rds")
...
encuesta_mrp <- encuesta %>%
  transmute(
    ...
    etnia = case_when(
                 etnia == 1          ~ "1", # Indigena
                 etnia %in% c(3,4,5) ~ "2", # afro negro mulato
                                TRUE ~ "3" # Otro
    ),
...
saveRDS(encuesta_mrp, file = "COL/2015/1.D6/Data/encuesta_mrp.rds")
saveRDS(encuesta_mrp, file = "COL/2015/2.D6m/Data/encuesta_mrp.rds")
saveRDS(encuesta_mrp, file = "COL/2015/3.NI/Data/encuesta_mrp.rds")
...
jpeg(filename = "COL/2015/1.D6/Output/plot_actualizacion_censo1.jpeg",
     width = 2000,
     height = 2000)
plot(censo_mrp$n, n1)
dev.off()
...
jpeg(filename = "COL/2015/1.D6/Output/plot_actualizacion_censo2.jpeg",
     width = 2000,
     height = 2000)
par(mfrow = c(2, 2))
hist(censo_mrp$n)
...
saveRDS(censo_mrp, "COL/2015/2.D6m/Data/censo_mrp.rds")
saveRDS(censo_mrp, "COL/2015/3.NI/Data/censo_mrp.rds")
