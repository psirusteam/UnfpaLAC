...
encuesta_mrp <- readRDS("ECU/2018/2.D6m/Data/encuesta_mrp.rds")
tasa_desocupados <- readRDS("ECU/2018/2.D6m/Data/tasa_desocupacion.rds")
...
#fit<-readRDS("ECU/2018/2.D6m/Data/fit_bayes.rds")

print(fit)


saveRDS(fit, file = "ECU/2018/2.D6m/Data/fit_bayes.rds")
...
############################################################
# fit_freq <- readRDS("ECU/2018/2.D6m/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("ECU/2018/2.D6m/Data/fit_bayes.rds")
...
# ggsave(filename = "ECU/2018/2.D6m/Output/Compara_modelos.jpeg", plot1, scale = 3)
