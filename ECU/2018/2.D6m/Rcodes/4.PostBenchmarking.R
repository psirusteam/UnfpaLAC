...
censo_mrp <- readRDS("ECU/2018/2.D6m/Data/censo_mrp.rds")
tasa_desocupados <- readRDS("ECU/2018/2.D6m/Data/tasa_desocupacion.rds")
fit <- readRDS("ECU/2018/2.D6m/Data/fit_mrp_logit.rds")
...
jpeg(file = "ECU/2018/2.D6m/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>%
        select(!matches("_\\d{,2}$")), 
        "ECU/2018/2.D6m/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "ECU/2018/2.D6m/Data/encuesta_mrp.RDS")
