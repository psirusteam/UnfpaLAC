...
#fit<-readRDS("ECU/2018/3.NI/Data/fit_bayes.rds")

print(fit)

saveRDS(fit, file = "ECU/2018/3.NI/Data/fit_bayes.rds")
...
############################################################
# fit_freq <- readRDS("ECU/2018/3.NI/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("ECU/2018/3.NI/Data/fit_bayes.rds")
...
# ggsave(filename = "ECU/2018/3.NI/Output/Compara_modelos.jpeg", plot1, scale = 3)
