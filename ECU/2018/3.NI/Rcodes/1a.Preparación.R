...
saveRDS(encuesta_mrp, file = "ECU/2018/3.NI/Data/encuesta_mrp.rds")
...
jpeg(filename = "ECU/2018/3.NI/Output/plot_actualizacion_censo1.jpeg",
     width = 2000,
     height = 2000)
plot(censo_mrp$n, n1)
dev.off()
...
jpeg(filename = "ECU/2018/3.NI/Output/plot_actualizacion_censo2.jpeg",
     width = 2000,
     height = 2000)
par(mfrow = c(2, 2))
hist(censo_mrp$n)
...
saveRDS(censo_mrp, "ECU/2018/3.NI/Data/censo_mrp.rds")
saveRDS(encuesta_mrp, file = "ECU/2018/3.NI/Data/encuesta_mrp.rds")
