...
# Loading data ------------------------------------------------------------
poststrat_df <- readRDS("ECU/2018/1.D6/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
...
bynames <- mutate(
  bynames,
  outPaht = paste0("ECU/2018/1.D6/Output/pobreza_", paste0(V1, "_", V2),
                   ".pdf")
)
...
tmap_save(
  Mapa_lp,
  "ECU/2018/1.D6/Output/Estados.pdf",
  width = 6920,
  height = 4080,
  asp = 0
)
...
openxlsx::write.xlsx(dat_df, file = "ECU/2018/1.D6/Output/tablas.xlsx", 
                     overwrite = TRUE, )
