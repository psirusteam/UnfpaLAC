...
####################################################
encuesta <- readRDS("ECU/2018/1.D6/Data/ENSANUT.rds")
...
encuesta_mrp <- encuesta %>%
  transmute(
    ...
    area = case_when(area == 1 ~ "1", area == 2 ~ "0"),
    ...
    unida = case_when(unida == 1 ~ "1", unida == 0 ~ "2"
    ),
...
saveRDS(encuesta_mrp, file = "ECU/2018/1.D6/Data/encuesta_mrp.rds")
saveRDS(encuesta_mrp, file = "ECU/2018/2.D6m/Data/encuesta_mrp.rds")
...
jpeg(filename = "ECU/2018/1.D6/Output/plot_actualizacion_censo1.jpeg",
     width = 2000,
     height = 2000)
plot(censo_mrp$n, n1)
dev.off()
...
jpeg(filename = "ECU/2018/1.D6/Output/plot_actualizacion_censo2.jpeg",
     width = 2000,
     height = 2000)
par(mfrow = c(2, 2))
hist(censo_mrp$n)
...
saveRDS(censo_mrp, "ECU/2018/2.D6m/Data/censo_mrp.rds")
