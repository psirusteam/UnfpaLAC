...
fit_mrp_logit_D6  <- readRDS("ECU/2018/1.D6/Data/fit_mrp_logit.rds")
fit_mrp_logit_D6m <- readRDS("ECU/2018/2.D6m/Data/fit_mrp_logit.rds")
fit_mrp_logit_NI  <- readRDS("ECU/2018/3.NI/Data/fit_mrp_logit.rds")
...
summary(poststrat_df$pobreza)

########################

saveRDS(poststrat_df %>%
          select(!matches("_\\d{,2}$")), 
        "ECU/2018/4.D7/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "ECU/2018/4.D7/Data/encuesta_mrp.RDS")
