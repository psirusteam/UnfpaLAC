...
# Loading data ------------------------------------------------------------
poststrat_df <- readRDS("ECU/2018/4.D7/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
...
bynames <- mutate(
  bynames,
  outPaht = paste0("ECU/2018/4.D7/Output/pobreza_", paste0(V1, "_", V2),
                   ".pdf")
)
...
brks_lp <- c(0, 0.4, 0.8, 0.85, 0.90, 0.95, 1)
...
openxlsx::write.xlsx(dat_df, file = "ECU/2018/4.D7/Output/tablas.xlsx", 
                     overwrite = TRUE, )
