...
fit <- readRDS("GTM/2014-2015/3.NI/Data/fit_mrp_logit.rds")
...
names_cov
names_cov <- c("area","etnia","edad","anoest")
...
jpeg(file = "GTM/2014-2015/3.NI/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>%
        select(!matches("_\\d{,2}$")), 
        "GTM/2014-2015/3.NI/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "GTM/2014-2015/3.NI/Data/encuesta_mrp.RDS")
