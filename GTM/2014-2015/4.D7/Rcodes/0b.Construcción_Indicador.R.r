...
fit_mrp_logit_D6  <- readRDS("GTM/2014-2015/1.D6/Data/fit_mrp_logit.rds")
fit_mrp_logit_D6m <- readRDS("GTM/2014-2015/2.D6m/Data/fit_mrp_logit.rds")
fit_mrp_logit_NI  <- readRDS("GTM/2014-2015/3.NI/Data/fit_mrp_logit.rds")
...
saveRDS(poststrat_df %>%
        ...
        "GTM/2014-2015/4.D7/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "GTM/2014-2015/4.D7/Data/encuesta_mrp.RDS")
