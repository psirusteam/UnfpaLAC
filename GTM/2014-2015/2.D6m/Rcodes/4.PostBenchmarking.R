...
jpeg(file = "GTM/2014-2015/2.D6m/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>%
        select(!matches("_\\d{,2}$")), 
        "GTM/2014-2015/2.D6m/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "GTM/2014-2015/2.D6m/Data/encuesta_mrp.RDS")
