...
# Loading data ------------------------------------------------------------
poststrat_df <- readRDS("GTM/2014-2015/2.D6m/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
...
bynames <- mutate(
  bynames,
  outPaht = paste0("GTM/2014-2015/2.D6m/Output/pobreza_", paste0(V1, "_", V2),
                   ".pdf")
)
...
tmap_save(
  Mapa_lp,
  "GTM/2014-2015/2.D6m/Output/Estados.pdf",
  width = 6920,
  height = 4080,
  asp = 0
)
...
openxlsx::write.xlsx(dat_df, file = "GTM/2014-2015/2.D6m/Output/tablas.xlsx", 
                     overwrite = TRUE, )
