...
saveRDS(fit, file = "GTM/2014-2015/1.D6/Data/fit_bayes.rds")
#
...
############################################################
# fit_freq <- readRDS("GTM/2014-2015/1.D6/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("GTM/2014-2015/1.D6/Data/fit_bayes.rds")
...
# ggsave(filename = "GTM/2014-2015/1.D6/Output/Compara_modelos.jpeg", plot1, scale = 3)
