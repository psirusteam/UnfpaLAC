...
#--- Patchwork in action ---#
(age_plot | etnia_plot | escolar_plot | area_plot) / ( depto_plot)
...
#--- Patchwork in action ---#
(p_edad_etnia + p_edad_escolar + p_edad_area ) / p_edad_depto
...
#--- Patchwork in action ---#
(p_etnia_escolar + p_etnia_area ) / p_etnia_depto
...
#--- Patchwork in action ---#
(p_escolar_area ) / p_escolar_depto
