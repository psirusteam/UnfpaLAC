...
encuesta_mrp <- readRDS("GTM/2014-2015/1.D6/Data/encuesta_mrp.rds")
poststrat_df <- readRDS("GTM/2014-2015/1.D6/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
tasa_desocupados <- readRDS("GTM/2014-2015/1.D6/Data/tasa_desocupacion.rds")
fit <- readRDS("GTM/2014-2015/1.D6/Data/fit_bayes.rds")

# Poststratification at the National Level --------------------------------

byAgrega <-
  grep(
    pattern =  "^(n|usametodo|usamoderno|necesInst|upm|estrato|fexp|n|X|F|tasa_desocupacion|epred_mat|gk|depto|lp|crops.coverfraction|urban.coverfraction|pobreza|stable_lights)",
...
openxlsx::write.xlsx(tablas, file = "GTM/2014-2015/1.D6/Output/tablas_ECM.xlsx", 
                     overwrite = TRUE)
