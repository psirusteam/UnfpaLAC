...
saveRDS(encuesta_mrp, file = "GTM/2014-2015/1.D6/Data/encuesta_mrp.rds")
saveRDS(encuesta_mrp, file = "GTM/2014-2015/2.D6m/Data/encuesta_mrp.rds")
...
jpeg(filename = "GTM/2014-2015/1.D6/Output/plot_actualizacion_censo1.jpeg",
     width = 2000,
     height = 2000)
plot(censo_mrp$n, n1)
dev.off()
...
jpeg(filename = "GTM/2014-2015/1.D6/Output/plot_actualizacion_censo2.jpeg",
     width = 2000,
     height = 2000)
par(mfrow = c(2, 2))
hist(censo_mrp$n)
...
saveRDS(censo_mrp, "GTM/2014-2015/2.D6m/Data/censo_mrp.rds")
