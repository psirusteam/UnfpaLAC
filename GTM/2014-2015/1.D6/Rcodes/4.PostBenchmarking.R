...
fit <- readRDS("GTM/2014-2015/1.D6/Data/fit_mrp_logit.rds")
...
### total
totales <- map(names_cov, ~encuesta_mrp %>%
                 group_by_at(all_of(.x)) %>% 
...
jpeg(file = "GTM/2014-2015/1.D6/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>%
        select(!matches("_\\d{,2}$")), 
        "GTM/2014-2015/1.D6/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "GTM/2014-2015/1.D6/Data/encuesta_mrp.RDS")
saveRDS(epred_mat, "GTM/2014-2015/4.D7/Data/epredmat_D6.RDS")
