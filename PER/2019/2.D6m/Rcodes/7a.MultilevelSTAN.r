...
encuesta_mrp <- readRDS("PER/2019/2.D6m/Data/encuesta_mrp.rds")
tasa_desocupados <- readRDS("PER/2019/2.D6m/Data/tasa_desocupacion.rds")
...
#fit<-readRDS("PER/2019/2.D6m/Data/fit_bayes.rds")

print(fit)

saveRDS(fit, file = "PER/2019/2.D6m/Data/fit_bayes.rds")
...
############################################################
# fit_freq <- readRDS("PER/2019/2.D6m/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("PER/2019/2.D6m/Data/fit_bayes.rds")
...
# ggsave(filename = "PER/2019/2.D6m/Output/Compara_modelos.jpeg", plot1, scale = 3)
