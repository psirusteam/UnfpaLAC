...
encuesta_mrp <- readRDS("PER/2019/3.NI/Data/encuesta_mrp.rds")
censo_mrp    <- readRDS("PER/2019/3.NI/Data/censo_mrp.rds")
Estima_D7    <- readRDS("PER/2019/4.D7/Data/poststrat_df.RDS")
##### Cargando los fit de los tres indicadores D6/D6m y NI
fit_mrp_stan_D6  <- readRDS("PER/2019/1.D6/Data/fit_bayes.rds")
fit_mrp_stan_D6m <- readRDS("PER/2019/2.D6m/Data/fit_bayes.rds")
fit_mrp_stan_NI  <- readRDS("PER/2019/3.NI/Data/fit_bayes.rds")
##### Cargando tasa de desocupación
tasa_desocupados <- readRDS("PER/2019/1.D6/Data/tasa_desocupacion.rds")
...
openxlsx::write.xlsx(tabla_est, file = "PER/2019/4.D7/Output/tablas_ECM.xlsx",
                     overwrite = TRUE)
