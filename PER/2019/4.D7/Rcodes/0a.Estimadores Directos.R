...
EndesMEF<-readRDS("PER/2019/4.D7/Data/base_estimaciones.rds")
...
####### ya que en el informe no se especifica la demanda satisfecha 
...
openxlsx::write.xlsx(D7_Depto, file = "PER/2019/4.D7/Output/Tablas/D7_Depto.xlsx")
...
openxlsx::write.xlsx(D7_area, file = "PER/2019/4.D7/Output/Tablas/D7_area.xlsx")
...
openxlsx::write.xlsx(D7_edad, file = "PER/2019/4.D7/Output/Tablas/D7_edad.xlsx")
...
openxlsx::write.xlsx(D7_anoest, file = "PER/2019/4.D7/Output/Tablas/D7_anoest.xlsx")
...
openxlsx::write.xlsx(D7_etnia, file = "PER/2019/4.D7/Output/Tablas/D7_etnia.xlsx")
...
openxlsx::write.xlsx(D7_discap, file = "PER/2019/4.D7/Output/Tablas/D7_Discp.xlsx")
...
openxlsx::write.xlsx(D7_area_anoest, file = "PER/2019/4.D7/Output/Tablas/D7_area_escolaridad.xlsx")
...
openxlsx::write.xlsx(D7_depto_edad, file = "PER/2019/4.D7/Output/Tablas/D7_Depto_edad.xlsx")
...
D7_mpio = design.base.total %>% group_by(Provincia) %>%
  summarise(n = unweighted(n()),
            D7 = survey_ratio(usamoderno,usametodo + nec_insat,
                              vartype = c("cv")))
...
openxlsx::write.xlsx(D7_mpio, file = "PER/2019/4.D7/Output/Tablas/D7_mpio.xlsx")
