...
tasa_desocupados <- readRDS("PER/2019/3.NI/Data/tasa_desocupacion.rds")
...
#fit<-readRDS("PER/2019/3.NI/Data/fit_bayes.rds")

print(fit)

saveRDS(fit, file = "PER/2019/3.NI/Data/fit_bayes.rds")
...
############################################################
# fit_freq <- readRDS("PER/2019/3.NI/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("PER/2019/3.NI/Data/fit_bayes.rds")
...
# ggsave(filename = "PER/2019/3.NI/Output/Compara_modelos.jpeg", plot1, scale = 3)
