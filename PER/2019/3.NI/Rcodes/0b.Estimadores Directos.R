...
EndesMEF<-readRDS("PER/2019/3.NI/Data/base_estimaciones.rds")
...
EndesMEF$nec_insat[is.na(EndesMEF$nec_insat)] <- 0
...
openxlsx::write.xlsx(NI_Depto, file = "PER/2019/3.NI/Output/Tablas/NI_Depto.xlsx")
...
openxlsx::write.xlsx(NI_area, file = "PER/2019/3.NI/Output/Tablas/NI_area.xlsx")
...
openxlsx::write.xlsx(NI_edad, file = "PER/2019/3.NI/Output/Tablas/NI_edad.xlsx")
...
openxlsx::write.xlsx(NI_anoest, file = "PER/2019/3.NI/Output/Tablas/NI_anoest.xlsx")
...
openxlsx::write.xlsx(NI_etnia, file = "PER/2019/3.NI/Output/Tablas/NI_etnia.xlsx")
...
openxlsx::write.xlsx(NI_discap, file = "PER/2019/3.NI/Output/Tablas/NI_Discp.xlsx")
...
openxlsx::write.xlsx(NI_area_anoest, file = "PER/2019/3.NI/Output/Tablas/NI_area_escolaridad.xlsx")
...
openxlsx::write.xlsx(NI_depto_edad, file = "PER/2019/3.NI/Output/Tablas/NI_Depto_edad.xlsx")
...
NI_mpio = design.base.unidas %>% group_by(Provincia) %>%
  summarise(n = unweighted(n()),
            NI = survey_mean(nec_insat,
                             vartype = c("cv")))
...
openxlsx::write.xlsx(NI_mpio, file = "PER/2019/3.NI/Output/Tablas/NI_mpio.xlsx")
