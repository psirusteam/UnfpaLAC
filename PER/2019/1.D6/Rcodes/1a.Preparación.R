...
####################################################
encuesta <- readRDS("PER/2019/1.D6/Data/ENdesMEF19.rds")
censo_mrp <- readRDS("PER/2019/1.D6/Data/censo_mrp.rds")
  ...
  transmute(
    ...
    etnia = case_when(
                 etnia %in% c("QUECHUA",
                               ...
                               "PERTENECIENTE O PARTE DE OTRO PUEBLO INDIGENA"
                                        ) ~ "1", # Indigena
                 etnia == "NEGRO /MORENO/ ZAMBO/MULATO/PUEBLO AFROPERUANO" 
                                          ~ "2", # afro negro mulato
                                     TRUE ~ "3" # Otro
    ),
...
saveRDS(encuesta_mrp, file = "PER/2019/1.D6/Data/encuesta_mrp.rds")
saveRDS(encuesta_mrp, file = "PER/2019/2.D6m/Data/encuesta_mrp.rds")
saveRDS(encuesta_mrp, file = "PER/2019/3.NI/Data/encuesta_mrp.rds")
...
jpeg(filename = "PER/2019/1.D6/Output/plot_actualizacion_censo1.jpeg",
     width = 2000,
     height = 2000)
plot(censo_mrp$n, n1)
dev.off()
...
jpeg(filename = "PER/2019/1.D6/Output/plot_actualizacion_censo2.jpeg",
     width = 2000,
     height = 2000)
par(mfrow = c(2, 2))
hist(censo_mrp$n)
...
saveRDS(censo_mrp, "PER/2019/2.D6m/Data/censo_mrp.rds")
saveRDS(censo_mrp, "PER/2019/3.NI/Data/censo_mrp.rds")
