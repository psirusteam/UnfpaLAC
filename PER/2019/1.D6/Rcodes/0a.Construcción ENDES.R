...
#############################################################################################################################################
# #
# # Proceso: Construcción BAse ENDES Completa (Todos los modulos) 2018
# #                                                ------------- reporte 2019
# #
# # Historia Archivo:
# #   Creation : 23/06/2022
...
# REC0111 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo66/638-Modulo66/REC0111.SAV",to.data.frame = TRUE)
# REC21 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo67/Modulo67/REC21.SAV", to.data.frame = TRUE)
# RE223132 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo67/Modulo67/RE223132.SAV", to.data.frame = TRUE)
# RE516171 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo71/Modulo71/RE516171.SAV",to.data.frame = TRUE)
# REC91 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo66/638-Modulo66/REC91.SAV",to.data.frame = TRUE)
# #
# RECH0 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo64/Modulo64/RECH0.SAV",to.data.frame = TRUE)
# RECH1 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo64/Modulo64/RECH1.SAV",to.data.frame = TRUE)
# RECH23 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo65/Modulo65/RECH23.SAV",to.data.frame = TRUE)
# RECH4 = read.spss("PER/2019/1.D6/Data/Modulos/638-Modulo64/Modulo64/RECH4.SAV",to.data.frame = TRUE)
# #
...
# #
# saveRDS(ENDESMEF, file = "PER/2019/1.D6/Data/ENDESMEF.rds")

## cargando la base de datos guardada

ENDESMEF <- readRDS(file = "PER/2019/1.D6/Data/ENDESMEF.rds")
...
ENDESMEF$escolaridad <- ifelse(ENDESMEF$SH15N == "Inicial", 0,
                           ifelse(ENDESMEF$SH15N == "Primaria", 1,
                                  ifelse(ENDESMEF$SH15N == "Secundaria", 2,
...
ENDESMEF$etnia2 <- ifelse(ENDESMEF$S119D == "QUECHUA", 1,
                          ifelse(ENDESMEF$S119D == "AYMARA", 1,
                                 ifelse(ENDESMEF$S119D == "NATIVO O INDIGENA DE LA AMAZONIA", 1,
                                        ifelse(ENDESMEF$S119D == "PERTENECIENTE O PARTE DE OTRO PUEBLO INDIGENA", 1,
                                               ifelse(ENDESMEF$S119D == "NEGRO /MORENO/ ZAMBO/MULATO/PUEBLO AFROPERUANO", 2,
...
ENDESMEF$usametodo = ifelse(ENDESMEF$V313 %in% c("Método moderno", "Método tradicional", 
                                                 "Método Folclórico"),
                            1,
                            0)
...
saveRDS(EndesMEF19, file = "PER/2019/1.D6/Data/EndesMEF19.rds")
...
saveRDS(ENDESMEF_Estima,"PER/2019/1.D6/Data/ENDESMEF_Estima.rds")
saveRDS(ENDESMEF_Estima,"PER/2019/2.D6m/Data/ENDESMEF_Estima.rds")
saveRDS(ENDESMEF_Estima,"PER/2019/3.NI/Data/ENDESMEF_Estima.rds")
saveRDS(ENDESMEF_Estima,"PER/2019/4.D7/Data/ENDESMEF_Estima.rds")
