...
bynames <- mutate(
  bynames,
  outPaht = paste0("PER/2019/1.D6/Output/pobreza_", paste0(V1, "_", V2),
                   ".pdf")
)
...
tmap_save(
  Mapa_lp,
  "PER/2019/1.D6/Output/Estados.pdf",
  width = 6920,
  height = 4080,
  asp = 0
)
...
openxlsx::write.xlsx(dat_df, file = "PER/2019/1.D6/Output/tablas.xlsx", 
                     overwrite = TRUE, )
