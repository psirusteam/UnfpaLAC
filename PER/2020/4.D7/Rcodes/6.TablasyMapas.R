...
# Loading data ------------------------------------------------------------
poststrat_df <- readRDS("PER/2020/4.D7/Data/poststrat_df.RDS") %>% 
  filter(anoest != "99")
...
bynames <- mutate(
  bynames,
  outPaht = paste0("PER/2020/4.D7/Output/pobreza_", paste0(V1, "_", V2),
                   ".pdf")
)
...
openxlsx::write.xlsx(dat_df, file = "PER/2020/4.D7/Output/tablas.xlsx", 
                     overwrite = TRUE, )
