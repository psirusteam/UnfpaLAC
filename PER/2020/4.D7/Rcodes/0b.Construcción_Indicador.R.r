...
fit_mrp_logit_D6  <- readRDS("PER/2020/1.D6/Data/fit_mrp_logit.rds")
fit_mrp_logit_D6m <- readRDS("PER/2020/2.D6m/Data/fit_mrp_logit.rds")
fit_mrp_logit_NI  <- readRDS("PER/2020/3.NI/Data/fit_mrp_logit.rds")
...
saveRDS(poststrat_df %>%
        ...
        "PER/2020/4.D7/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "PER/2020/4.D7/Data/encuesta_mrp.RDS")
