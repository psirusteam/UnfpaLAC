...
#fit<-readRDS("PER/2020/3.NI/Data/fit_bayes.rds")

print(fit)

saveRDS(fit, file = "PER/2020/3.NI/Data/fit_bayes.rds")
...
############################################################
# fit_freq <- readRDS("PER/2020/3.NI/Data/fit_mrp_logit.rds")
# fit_Bayes <- readRDS("PER/2020/3.NI/Data/fit_bayes.rds")
...
# ggsave(filename = "PER/2020/3.NI/Output/Compara_modelos.jpeg", plot1, scale = 3)
