...
bynames <- mutate(
  bynames,
  outPaht = paste0("PER/2020/2.D6m/Output/pobreza_", paste0(V1, "_", V2),
                   ".pdf")
)
...
## Leer Shape del pais
ShapeSAE <- read_sf("PER/2020/ShapesPER/PROVINCIAS.shp")
...
tmap_save(
  Mapa_lp,
  "PER/2020/2.D6m/Output/Estados.pdf",
  width = 6920,
  height = 4080,
  asp = 0
)
...
openxlsx::write.xlsx(dat_df, file = "PER/2020/2.D6m/Output/tablas.xlsx", 
                     overwrite = TRUE, )
