...
censo_mrp <- readRDS("PER/2020/2.D6m/Data/censo_mrp.rds")
tasa_desocupados <- readRDS("PER/2020/2.D6m/Data/tasa_desocupacion.rds")
fit <- readRDS("PER/2020/2.D6m/Data/fit_mrp_logit.rds")
...
jpeg(file = "PER/2020/2.D6m/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>%
        select(!matches("_\\d{,2}$")), 
        "PER/2020/2.D6m/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "PER/2020/2.D6m/Data/encuesta_mrp.RDS")
