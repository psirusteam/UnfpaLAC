...
####################################################
encuesta <- readRDS("PER/2021/1.D6/Data/ENdesMEF21.rds")
censo_mrp <- readRDS("PER/2021/1.D6/Data/censo_mrp.rds")
...
encuesta_mrp <- encuesta %>%
  transmute(
    ...
    area = case_when(area == "Urbano" ~ "1", TRUE ~ "0"),
    ...
    etnia = case_when(
      ...
      # Indigena
      etnia == "Negro/ Moreno/ Zambo/ Mulato/Pueblo Afroperuano o afrodescendiente" ~ "2",
      # afro negro mulato
      TRUE ~ "3"
    ),
    # Otro
    ...
    unida = case_when(unida == 1 ~ "1", unida == 2 ~ "2"
    ),
...
saveRDS(encuesta_mrp, file = "PER/2021/1.D6/Data/encuesta_mrp.rds")
saveRDS(encuesta_mrp, file = "PER/2021/2.D6m/Data/encuesta_mrp.rds")
saveRDS(encuesta_mrp, file = "PER/2021/3.NI/Data/encuesta_mrp.rds")
...
jpeg(filename = "PER/2021/1.D6/Output/plot_actualizacion_censo1.jpeg",
     width = 2000,
     height = 2000)
plot(censo_mrp$n, n1)
dev.off()
...
jpeg(filename = "PER/2021/1.D6/Output/plot_actualizacion_censo2.jpeg",
     width = 2000,
     height = 2000)
par(mfrow = c(2, 2))
hist(censo_mrp$n)
...
saveRDS(censo_mrp, "PER/2021/1.D6/Data/censo_mrp.rds")
saveRDS(censo_mrp, "PER/2021/2.D6m/Data/censo_mrp.rds")
saveRDS(censo_mrp, "PER/2021/3.NI/Data/censo_mrp.rds")
