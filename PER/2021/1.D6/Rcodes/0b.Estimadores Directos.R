...
EndesMEF = readRDS("PER/2021/1.D6/Data/ENDESMEF_Estima.rds")
...
EndesMEF$DemandaT[is.na(EndesMEF$DemandaT)] <- 0
table(EndesMEF$DemandaT, useNA = "a")

##### Adecuando los datos

names(EndesMEF)

#EndesMEF<-readRDS("PER/2021/1.D6/Data/base_estimaciones.rds")
...
EndesMEF <- EndesMEF %>%
  transmute(
    ...
    nec_insat  = nec_insat,
    nec_insat2  = nec_insat2,
    
    
    area = case_when(area == "Urbano" ~ "Urbano", 
                                 TRUE ~ "Rural"),
...
# saveRDS(EndesMEF,"PER/2021/1.D6/Data/base_estimaciones.rds")
# saveRDS(EndesMEF,"PER/2021/2.D6m/Data/base_estimaciones.rds")
# saveRDS(EndesMEF,"PER/2021/3.NI/Data/base_estimaciones.rds")
# saveRDS(EndesMEF,"PER/2021/4.D7/Data/base_estimaciones.rds")
...
openxlsx::write.xlsx(D6_Depto, file = "PER/2021/1.D6/Output/Tablas/D6_Depto.xlsx")
...
openxlsx::write.xlsx(D6_area, file = "PER/2021/1.D6/Output/Tablas/D6_area.xlsx")
...
openxlsx::write.xlsx(D6_edad, file = "PER/2021/1.D6/Output/Tablas/D6_edad.xlsx")
...
openxlsx::write.xlsx(D6_anoest, file = "PER/2021/1.D6/Output/Tablas/D6_anoest.xlsx")
...
openxlsx::write.xlsx(D6_etnia, file = "PER/2021/1.D6/Output/Tablas/D6_etnia.xlsx")
...
openxlsx::write.xlsx(D6_discap, file = "PER/2021/1.D6/Output/Tablas/D6_Discp.xlsx")
...
openxlsx::write.xlsx(D6_area_anoest, file = "PER/2021/1.D6/Output/Tablas/D6_area_escolaridad.xlsx")
...
openxlsx::write.xlsx(D6_depto_edad, file = "PER/2021/1.D6/Output/Tablas/D6_Depto_edad.xlsx")
...
openxlsx::write.xlsx(D6_mpio, file = "PER/2021/1.D6/Output/Tablas/D6_mpio.xlsx")
