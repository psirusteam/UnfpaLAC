...
EndesMEF<-readRDS("PER/2021/2.D6m/Data/base_estimaciones.rds")
...
openxlsx::write.xlsx(D6m_Depto, file = "PER/2021/2.D6m/Output/Tablas/D6m_Depto.xlsx")
...
openxlsx::write.xlsx(D6m_area, file = "PER/2021/2.D6m/Output/Tablas/D6m_area.xlsx")
...
openxlsx::write.xlsx(D6m_edad, file = "PER/2021/2.D6m/Output/Tablas/D6m_edad.xlsx")
...
openxlsx::write.xlsx(D6m_anoest, file = "PER/2021/2.D6m/Output/Tablas/D6m_anoest.xlsx")
...
openxlsx::write.xlsx(D6m_etnia, file = "PER/2021/2.D6m/Output/Tablas/D6m_etnia.xlsx")
...
openxlsx::write.xlsx(D6m_discap, file = "PER/2021/2.D6m/Output/Tablas/D6m_Discp.xlsx")
...
openxlsx::write.xlsx(D6m_area_anoest, file = "PER/2021/2.D6m/Output/Tablas/D6m_area_escolaridad.xlsx")
...
openxlsx::write.xlsx(D6m_depto_edad, file = "PER/2021/2.D6m/Output/Tablas/D6m_Depto_edad.xlsx")
...
D6m_mpio = design.base.total %>% group_by(Provincia) %>%
  summarise(n = unweighted(n()),
            D6m = survey_mean(usamoderno,
                             vartype = c("cv")))
...
openxlsx::write.xlsx(D6m_mpio, file = "PER/2021/2.D6m/Output/Tablas/D6m_mpio.xlsx")
