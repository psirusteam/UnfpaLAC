...
EndesMEF<-readRDS("PER/2021/3.NI/Data/base_estimaciones.rds")
...
####################
## Nivel Nacional ##
####################  Cuadro informe nacional (Anexo en Excel 6.6)
...
####### Por Departamento  
#######      (Mujeres Unidas) Cuadro informe nacional (Anexo en Excel 6.7)
...
openxlsx::write.xlsx(NI_Depto, file = "PER/2021/3.NI/Output/Tablas/NI_Depto.xlsx")


####### Area (Mujeres Unidas) Cuadro informe nacional (Anexo en Excel 6.7)
...
openxlsx::write.xlsx(NI_area, file = "PER/2021/3.NI/Output/Tablas/NI_area.xlsx")

####### Edad Cuadro informe nacional (Anexo en Excel 6.6)
...
openxlsx::write.xlsx(NI_edad, file = "PER/2021/3.NI/Output/Tablas/NI_edad.xlsx")

####### Años estudio 
#######(Mujeres Unidas) Cuadro informe nacional (Anexo en Excel 6.6) 
...
openxlsx::write.xlsx(NI_anoest, file = "PER/2021/3.NI/Output/Tablas/NI_anoest.xlsx")
...
openxlsx::write.xlsx(NI_etnia, file = "PER/2021/3.NI/Output/Tablas/NI_etnia.xlsx")
...
openxlsx::write.xlsx(NI_discap, file = "PER/2021/3.NI/Output/Tablas/NI_Discp.xlsx")
...
NI_area_anoest = design.base.total %>% group_by(area, anoest) %>%
  summarise(n = unweighted(n()),
            NI = survey_mean(nec_insat,
                             vartype = c("cv")))
...
openxlsx::write.xlsx(NI_area_anoest, file = "PER/2021/3.NI/Output/Tablas/NI_area_escolaridad.xlsx")
...
NI_depto_edad = design.base.total %>% group_by(Depto, edad) %>%
  summarise(n = unweighted(n()),
            NI = survey_mean(nec_insat,
                             vartype = c("cv")))
...
openxlsx::write.xlsx(NI_depto_edad, file = "PER/2021/3.NI/Output/Tablas/NI_Depto_edad.xlsx")
...
NI_mpio = design.base.total %>% group_by(Provincia) %>%
  summarise(n = unweighted(n()),
            NI = survey_mean(nec_insat,
                             vartype = c("cv")))
...
openxlsx::write.xlsx(NI_mpio, file = "PER/2021/3.NI/Output/Tablas/NI_mpio.xlsx")
