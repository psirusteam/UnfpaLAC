...
tasa_desocupados <- readRDS("PER/2021/3.NI/Data/tasa_desocupacion.rds")
fit <- readRDS("PER/2021/3.NI/Data/fit_mrp_logit.rds")
...
jpeg(file = "PER/2021/3.NI/Output/Plot_Bench_Pobreza.jpeg")
hist(poststrat_df$gk)
dev.off()

saveRDS(poststrat_df %>%
        select(!matches("_\\d{,2}$")),
        "PER/2021/3.NI/Data/poststrat_df.RDS")

saveRDS(encuesta_mrp, "PER/2021/3.NI/Data/encuesta_mrp.RDS")
